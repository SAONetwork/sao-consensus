...
type QueryFaultRequest struct {
	FaultId uint64 `protobuf:"varint,1,opt,name=fault_id,json=faultId,proto3" json:"fault_id,omitempty"`
}
...
func (m *QueryFaultRequest) GetFaultId() uint64 {
	if m != nil {
		return m.FaultId
	}
	return 0
...
func (m *QueryAllFaultsRequest) GetShard() uint64 {
	if m != nil {
		return m.Shard
	}
	return 0
...
var fileDescriptor_90d6cf38247b620b = []byte{
	...
	,
}
...
func (m *QueryFaultRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.FaultId != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.FaultId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *QueryAllFaultsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Shard != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.Shard))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Provider) > 0 {
