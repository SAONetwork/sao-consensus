...
type QueryGetNodeInTextResponse struct {
	NodeInText NodeInText `protobuf:"bytes,1,opt,name=NodeInText,proto3" json:"NodeInText"`
}

func (m *QueryGetNodeInTextResponse) Reset()         { *m = QueryGetNodeInTextResponse{} }
func (m *QueryGetNodeInTextResponse) String() string { return proto.CompactTextString(m) }
func (*QueryGetNodeInTextResponse) ProtoMessage()    {}
func (*QueryGetNodeInTextResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_90d6cf38247b620b, []int{4}
}
func (m *QueryGetNodeInTextResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetNodeInTextResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetNodeInTextResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetNodeInTextResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetNodeInTextResponse.Merge(m, src)
}
func (m *QueryGetNodeInTextResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetNodeInTextResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetNodeInTextResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetNodeInTextResponse proto.InternalMessageInfo

func (m *QueryGetNodeInTextResponse) GetNodeInText() NodeInText {
	if m != nil {
		return m.NodeInText
	}
	return NodeInText{}
...
type QueryAllNodeInTextResponse struct {
	Node       []NodeInText        `protobuf:"bytes,1,rep,name=node,proto3" json:"node"`
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryAllNodeInTextResponse) Reset()         { *m = QueryAllNodeInTextResponse{} }
func (m *QueryAllNodeInTextResponse) String() string { return proto.CompactTextString(m) }
func (*QueryAllNodeInTextResponse) ProtoMessage()    {}
func (*QueryAllNodeInTextResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_90d6cf38247b620b, []int{7}
}
func (m *QueryAllNodeInTextResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryAllNodeInTextResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryAllNodeInTextResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryAllNodeInTextResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryAllNodeInTextResponse.Merge(m, src)
}
func (m *QueryAllNodeInTextResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryAllNodeInTextResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryAllNodeInTextResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryAllNodeInTextResponse proto.InternalMessageInfo

func (m *QueryAllNodeInTextResponse) GetNode() []NodeInText {
	if m != nil {
		return m.Node
	}
	return nil
...
func (m *QueryAllNodeInTextResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *QueryAllFaultsRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
type QueryAllFaultsResponse struct {
	FaultIds   []string            `protobuf:"bytes,1,rep,name=FaultIds,proto3" json:"FaultIds,omitempty"`
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
func (m *QueryAllFaultsResponse) GetFaultIds() []string {
	if m != nil {
		return m.FaultIds
	}
	return nil
...
func (*QueryFishmenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_90d6cf38247b620b, []int{22}
}
...
type QueryFishmenResponse struct {
	Fishmen string `protobuf:"bytes,1,opt,name=fishmen,proto3" json:"fishmen,omitempty"`
}
...
func (*QueryFishmenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_90d6cf38247b620b, []int{23}
}
...
func (m *QueryFishmenResponse) GetFishmen() string {
	if m != nil {
		return m.Fishmen
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*QueryGetNodeInTextResponse)(nil), "saonetwork.sao.node.QueryGetNodeInTextResponse")
	...
	proto.RegisterType((*QueryAllNodeInTextResponse)(nil), "saonetwork.sao.node.QueryAllNodeInTextResponse")
...
var fileDescriptor_90d6cf38247b620b = []byte{
	...
	,
}
...
func (m *QueryGetNodeInTextResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetNodeInTextResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetNodeInTextResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.NodeInText.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *QueryAllNodeInTextResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryAllNodeInTextResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryAllNodeInTextResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryAllFaultsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FaultIds) > 0 {
		for iNdEx := len(m.FaultIds) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintQuery(dAtA, i, uint64(len(m.FaultIds[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *QueryFishmenResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Fishmen) > 0 {
		i -= len(m.Fishmen)
		copy(dAtA[i:], m.Fishmen)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.Fishmen)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QueryGetNodeInTextResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryAllNodeInTextResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetNodeInTextResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetNodeInTextResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetNodeInTextResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeInText", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.NodeInText.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *QueryAllNodeInTextResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryAllNodeInTextResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryAllNodeInTextResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Node = append(m.Node, NodeInText{})
			if err := m.Node[len(m.Node)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *QueryFishmenResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Fishmen = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
