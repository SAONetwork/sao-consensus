...
import (
	context "context"
	fmt "fmt"
	types "github.com/SaoNetwork/sao/x/sao/types"
...
type QueryGetMetadataResponse struct {
	...
	Shards   map[string]*types.Shard `protobuf:"bytes,3,rep,name=shards,proto3" json:"shards,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *QueryGetMetadataResponse) GetShards() map[string]*types.Shard {
	if m != nil {
		return m.Shards
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*types.Shard)(nil), "saonetwork.sao.model.QueryGetMetadataResponse.ShardsEntry")
...
var fileDescriptor_7ed1e5616dfbc517 = []byte{
	...
	,
}
...
func (m *QueryGetMetadataResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Shards == nil {
				m.Shards = make(map[string]*types.Shard)
			}
			var mapkey string
			var mapvalue *types.Shard
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
