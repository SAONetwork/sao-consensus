...
type Credit struct {
	...
	Bonds   github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=bonds,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"bonds"`
}
...
func (*Credit) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7e39861d4d05a88, []int{0}
}
...
func (m *Credit) GetAccount() string {
	if m != nil {
		return m.Account
	}
	return ""
...
func init() {
	proto.RegisterType((*Credit)(nil), "saonetwork.sao.loan.Credit")
}

func init() { proto.RegisterFile("sao/loan/credit.proto", fileDescriptor_a7e39861d4d05a88) }

var fileDescriptor_a7e39861d4d05a88 = []byte{
	// 235 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2d, 0x4e, 0xcc, 0xd7,
	0xcf, 0xc9, 0x4f, 0xcc, 0xd3, 0x4f, 0x2e, 0x4a, 0x4d, 0xc9, 0x2c, 0xd1, 0x2b, 0x28, 0xca, 0x2f,
	...
	,
}
...
func (m *Credit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.Bonds.Size()
		i -= size
		if _, err := m.Bonds.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintCredit(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x12
	if len(m.Account) > 0 {
		...
		i = encodeVarintCredit(dAtA, i, uint64(len(m.Account)))
		i--
		dAtA[i] = 0xa
	}
