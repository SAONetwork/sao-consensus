...
type MsgUpdataPermission struct {
	...
	Readwrite string `protobuf:"bytes,3,opt,name=readwrite,proto3" json:"readwrite,omitempty"`
}
...
func (m *MsgUpdataPermission) GetReadonly() string {
	if m != nil {
		return m.Readonly
	}
	return ""
...
func (m *MsgUpdataPermission) GetReadwrite() string {
	if m != nil {
		return m.Readwrite
	}
	return ""
...
var fileDescriptor_f7ec209c4d0a2095 = []byte{
	...
	,
}
...
func (m *MsgUpdataPermission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Readwrite) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.Readwrite)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Readonly) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.Readonly)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
