 ...
 */
export interface EarnQueryParamsResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/SaoNetwork/sao/earn/params
   */
   ...
   * @request GET:/SaoNetwork/sao/earn/pool
   */
  queryPool = (params: RequestParams = {}) =>
    this.request<EarnQueryGetPoolResponse, RpcStatus>({
      path: `/SaoNetwork/sao/earn/pool`,
      method: "GET",
      format: "json",
      ...params,
    });
